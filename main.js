				...
				if (res.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						...
						$author$project$Capacitor$showAlert(
							{
								message: 'Something went wrong when trying to authorize: ' + $author$project$Page$errToString(e),
								title: 'Error'
							}));
				}
		}
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				case 'NoOp':
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				case 'DummyAPIResponseReceived':
					var res = msg.a;
					return _Utils_Tuple2(
						model,
						$author$project$Capacitor$showAlert(
							{
								message: $elm$core$Debug$toString(res),
								title: 'Test'
							}));
				case 'DoLogin':
					return _Utils_Tuple2(
